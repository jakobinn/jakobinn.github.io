...
const ImageList = ({ photos, layout }) => {
	const settingsMain = { ...settings, photos: photos };
	if (photos && photos.length > 4) settingsMain.layout = [4, 4];

	return <ReactPhotoCollage {...settingsMain} />;
};
